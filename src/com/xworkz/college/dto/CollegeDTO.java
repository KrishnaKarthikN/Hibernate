...
public class CollegeDTO implements java.io.Serializable {
	...
	public String toString() {
		String formattedData = String.format("%-6s%-8s%-12s%-14s%-18s%s", collegeID , cname , location, noOfStudents , noOfRooms, noOfBranches);
//		return "CollegeDTO [collegeID=" + collegeID + ", cname=" + cname + ", location=" + location + ", noOfStudents="
//				+ noOfStudents + ", noOfRooms=" + noOfRooms + ", noOfBranches=" + noOfBranches + "]";
